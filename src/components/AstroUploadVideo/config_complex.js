...
const fields = {
  'HoroscopeAstroDetails.sign': {
    label: "Rashi",
    type: "select",
    valueSources: ["value"],
    fieldSettings: {
      listValues: rashiValues
    }
  },
  'HoroscopeAstroDetails.ascendant': {
    label: "Lagna",
    type: "select",
    valueSources: ["value"],
    fieldSettings: {
  ...
  'HoroscopeAstroDetails.nakshatra': {
    label: "Nakshatra",
    type: "select",
    valueSources: ["value"],
    fieldSettings: {
      listValues: nakshatraValues
    }
  },
  // dasha: {
  //   label: "Dasha",
  ...
  //   valueSources: ["value"],
  //   fieldSettings: {
  //     listValues: antardasha
  //   }
  // },
  // SaturnTransitHouse: {
  //   label: "Saturn transit house",
  //   type: "select",
  //   valueSources: ["value"],
  //   fieldSettings: {
